namespace MyNamespace.V1
{
    public partial class Client 
    {
        private System.Net.Http.HttpClient _httpClient;
        private Newtonsoft.Json.JsonSerializerSettings _serializerSettings;
        private Microsoft.Extensions.Logging.ILogger<Client> _logger;

        public Client(System.Net.Http.HttpClient httpClient, Microsoft.Extensions.Logging.ILogger<Client> logger)
        {
        ...
        public async System.Threading.Tasks.Task<System.Collections.Generic.List<DotRez.Api.Tests.Integration.Models.Order>> ApiOrdersGetAsync(DotRezCore.Api.Controllers.GetOrderRequest request)
        { 
            ...
            try
            {
                ...
                var result = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.Generic.List<DotRez.Api.Tests.Integration.Models.Order>>(content, _serializerSettings);
                return result;
            }
        ...
        public async System.Threading.Tasks.Task<System.Net.Http.HttpResponseMessage> ApiOrdersGetResponseAsync(DotRezCore.Api.Controllers.GetOrderRequest request)
        {
        ...
        public async System.Threading.Tasks.Task<DotRez.Api.Tests.Integration.Models.Order> ApiOrdersPostAsync(DotRez.Api.Tests.Integration.Models.Order order)
        { 
            string content = string.Empty;
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                content = await response.Content.ReadAsStringAsync();
                var result = Newtonsoft.Json.JsonConvert.DeserializeObject<DotRez.Api.Tests.Integration.Models.Order>(content, _serializerSettings);
                return result;
            }
            catch(System.Exception ex)
            {
        ...
        public async System.Threading.Tasks.Task<System.Net.Http.HttpResponseMessage> ApiOrdersPostResponseAsync(DotRez.Api.Tests.Integration.Models.Order order)
        {
            using(var httpRequestMessage = new System.Net.Http.HttpRequestMessage())
            {
                var urlStringBuilder = new System.Text.StringBuilder("api/Orders");
        ...
        public async System.Threading.Tasks.Task<System.Collections.Generic.Dictionary<string, DotRez.Api.Tests.Integration.Models.Order>> ApiOrdersGetSomethingElseGetAsync(int id, int id2, System.DateTime id3)
        { 
            string content = string.Empty;
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                content = await response.Content.ReadAsStringAsync();
                var result = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.Generic.Dictionary<string, DotRez.Api.Tests.Integration.Models.Order>>(content, _serializerSettings);
                return result;
            }
            catch(System.Exception ex)
            {
        ...
        public async System.Threading.Tasks.Task<DotRez.Api.Tests.Integration.Models.Order> ApiOrdersByIdGetAsync(int id)
        { 
            string content = string.Empty;
            try
            {
        ...
        public async System.Threading.Tasks.Task<System.Collections.Generic.List<DotRez.Api.Tests.Integration.Models.Person>> ApiPeopleGetAsync()
        { 
            string content = string.Empty;
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                content = await response.Content.ReadAsStringAsync();
                var result = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.Generic.List<DotRez.Api.Tests.Integration.Models.Person>>(content, _serializerSettings);
                return result;
            }
            catch(System.Exception ex)
            {
        ...
        public async System.Threading.Tasks.Task<DotRez.Api.Tests.Integration.Models.Person> ApiPeopleByIdGetAsync(int id)
        { 
            string content = string.Empty;
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                content = await response.Content.ReadAsStringAsync();
                var result = Newtonsoft.Json.JsonConvert.DeserializeObject<DotRez.Api.Tests.Integration.Models.Person>(content, _serializerSettings);
                return result;
            }
            catch(System.Exception ex)
            {
